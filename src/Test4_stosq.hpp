...
/// BenchMark setting data in memory using 64-bit `stosq` instructions
class [[maybe_unused]] Test4_stosq : public LogRunner {
public:
   /// Create a Test4_stosq as using buffers that are a power of 2
