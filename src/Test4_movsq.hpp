...
/// BenchMark setting data in memory using 64-bit `movsq` instructions
class [[maybe_unused]] Test4_movsq : public LogRunner {
public:
   /// Create a Test4_movsq as using buffers that are a power of 2
